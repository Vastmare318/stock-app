...
st.caption("東証33業種・全銘柄連携データ ｜ 主要8銘柄＆毎朝の経済ニュース対応")
...
# ==========================================
with tab6:
    st.subheader("🌅 毎朝の経済ニュース要約（小学生でもわかる解説）")
    st.write("本日の株式相場に影響を与えそうな最新の経済ニュースを3つピックアップしてお届けします。")
    st.markdown("---")

    st.markdown("### 1. アメリカの「長〜いおカネの金利」が約3年ぶりの高くなったよ")
    st.markdown("""
    * アメリカで、国におカネを貸したときにもらえる利息（長期金利）が大きく上がって、約3年ぶりの高くなったんだ。
    * モノの値段が上がり続けていることや、国におカネの心配があることが原因で、みんなが国債という証券を売ったのが理由だよ。
    ...
    * 「AIをもっとすごくするのには、少し時間がかかるかも？」という心配や、AIを作る会社からの発言がきっかけになったよ。
    * でも、市場全体で見ると、AI以外の他の会社の株はしっかり買われているところもあって、みんなの注目するものが変わりつつあるよ。
    """)
    ...
    * お金の値段が変わるかもしれない大切な時期なので、日本の株や円の値段（為替）がどう動くか、大人の人たちがとても気にとめているんだ。
    ...
    st.markdown("---")
    st.info("💡 忙しい朝でもサクッとチェックして、今日も一日元気にいってらっしゃい！")
